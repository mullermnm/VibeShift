  ...
  focused: [
    {
      ...
      fallbackGradient: 'linear-gradient(135deg, #2C3E50 0%, #34495E 100%)',
    ...
    },
    {
      ...
      fallbackGradient: 'linear-gradient(135deg, #3E5151 0%, #DECBA4 100%)',
    ...
    },
    {
      ...
      fallbackGradient: 'linear-gradient(135deg, #E6DADA 0%, #274046 100%)',
    ...
    },
    {
      ...
      fallbackGradient: 'linear-gradient(135deg, #4B6455 0%, #2C3E50 100%)',
  ...
  feminine: [
    {
      ...
      fallbackGradient: 'linear-gradient(135deg, #FFB6C1 0%, #FFF0F5 100%)',
    ...
    },
    {
      ...
      fallbackGradient: 'linear-gradient(135deg, #FFD1DC 0%, #FFDAB9 100%)',
    ...
    },
    {
      ...
      fallbackGradient: 'linear-gradient(135deg, #FFC0CB 0%, #FFE4E1 100%)',
    ...
    },
    {
      ...
      fallbackGradient: 'linear-gradient(135deg, #F8C8DC 0%, #FFF5F5 100%)',
  ...
  energetic: [
    {
      ...
      fallbackGradient: 'linear-gradient(45deg, #FF6B35 0%, #F7B801 50%, #6A00F4 100%)',
    ...
    },
    {
      ...
      fallbackGradient: 'linear-gradient(45deg, #FF4E50 0%, #F9D423 100%)',
    ...
    },
    {
      ...
      fallbackGradient: 'linear-gradient(45deg, #667eea 0%, #764ba2 50%, #f093fb 100%)',
    ...
    },
    {
      ...
      fallbackGradient: 'linear-gradient(45deg, #FF512F 0%, #DD2476 100%)',
  ...
  calm: [
    {
      ...
      fallbackGradient: 'linear-gradient(180deg, #5DADE2 0%, #1ABC9C 100%)',
    ...
    },
    {
      ...
      fallbackGradient: 'linear-gradient(180deg, #A8E6CF 0%, #3B8686 100%)',
    ...
    },
    {
      ...
      fallbackGradient: 'linear-gradient(180deg, #89CFF0 0%, #4682B4 100%)',
    ...
    },
    {
      ...
      fallbackGradient: 'linear-gradient(180deg, #B8D4B8 0%, #5F9EA0 100%)',
